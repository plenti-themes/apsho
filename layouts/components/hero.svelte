<script>
    export let title, subtitle, body, heroImage, appleStore, googlePlay;
</script>
<section class="hero">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 order-2 order-lg-1">
          <div class="hero-content">
            <span class="hero-content-subtitle">{subtitle}</span>
            <h1>{title}</h1>
            <p>
             {body}
            </p>
